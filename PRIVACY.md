...
- Name/Handle: maheis
- Contact: [insert e‑mail address or project page here]
...
7. Data sharing
----------------
There is no sharing with third parties unless you export or share data yourself. If cloud sync or external crash/analytics services are added in the future, this privacy policy will be updated and users will be informed explicitly.
...
----------------------------------
This policy may be updated from time to time. The current version is available in this repository as `PRIVACY_EN.md`.

Note: Please add a valid contact e‑mail or project page under "Data Controller" so users can reach you.
